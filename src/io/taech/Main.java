...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        CompleteSearch<Node> dfs = CompleteSearchManager.searchAs(SearchOption.DFS, 13);
        ...
        dfs.addNeighbours(4, dfs.once(5));
        dfs.addNeighbours(5, dfs.once(2, 4, 9));
        dfs.addNeighbours(7, dfs.once(2, 3, 8, 13));
        dfs.addNeighbours(8, dfs.once(7));
        dfs.addNeighbours(9, dfs.once(4));
        dfs.addNeighbours(13, dfs.once(7));
